...
async fn mint() {
    ...
    let liquidity_logs = fixture.exchange_instance.logs_with_type::<LiquidityAdded>(&result.receipts).unwrap();
...
async fn burn() {
    ...
    let burn_logs = fixture.exchange_instance.logs_with_type::<LiquidityRemoved>(&receipt.receipts).unwrap();
