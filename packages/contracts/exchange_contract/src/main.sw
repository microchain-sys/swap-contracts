...
impl Exchange for Contract {
    ...
    #[storage(read, write)]fn add_liquidity(min_liquidity: u64, deadline: u64) -> u64 {
        ...
        if total_liquidity > 0 {
            ...
            if (current_token_amount >= token_amount) {
                ...
                store_reserves(eth_reserve + current_eth_amount, token_reserve + token_amount);
            ...
            // Add fund to the reserves
            store_reserves(current_eth_amount, current_token_amount);
    ...
    #[storage(read, write)]fn remove_liquidity(min_eth: u64, min_tokens: u64, deadline: u64) -> RemoveLiquidityInfo {
        ...
        store_reserves(eth_reserve - eth_amount, token_reserve - token_amount);
    ...
    #[storage(read, write)]fn swap_with_minimum(min: u64, deadline: u64) -> u64 {
        ...
        if (asset_id == ETH_ID) {
            ...
            // Update reserve
            store_reserves(eth_reserve + forwarded_amount, token_reserve - tokens_bought);
        } else {
            ...
            bought = eth_bought;
            // Update reserve
            store_reserves(eth_reserve - eth_bought, token_reserve + bought);
        };
        bought
    }
    ...
    #[storage(read, write)]fn swap_with_maximum(amount: u64, deadline: u64) -> u64 {
        ...
        if (asset_id == ETH_ID) {
            ...
            sold = eth_sold;
            // Update reserve
            store_reserves(eth_reserve + eth_sold, token_reserve - amount);
        } else {
            ...
            sold = tokens_sold;
            // Update reserve
            store_reserves(eth_reserve - amount, token_reserve + tokens_sold);
        };
        sold
    }
